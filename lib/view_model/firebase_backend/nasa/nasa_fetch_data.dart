...
class NasaUpComingMission extends StatefulWidget {
  const NasaUpComingMission({super.key});

  @override
  State<NasaUpComingMission> createState() => _NasaUpComingMissionState();
}

class _NasaUpComingMissionState extends State<NasaUpComingMission> {
...
// You might want to show a different indicator here, or nothing at all
              ...
              final mission = streamSnapshot.data!.docs.elementAt(1)["mission"];
