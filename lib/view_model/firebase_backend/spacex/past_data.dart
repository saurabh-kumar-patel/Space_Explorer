...
class SpaceXPastMission extends StatefulWidget {
  const SpaceXPastMission({super.key});

  @override
  State<SpaceXPastMission> createState() => _SpaceXPastMissionState();
}

class _SpaceXPastMissionState extends State<SpaceXPastMission> {
...
// You might want to show a different indicator here, or nothing at all
              ...
              final missiondata =
                  streamSnapshot.data!.docs.elementAt(2)["mission"];
