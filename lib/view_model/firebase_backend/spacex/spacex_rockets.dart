...
class SpacexRockets extends StatefulWidget {
  const SpacexRockets({super.key});

  @override
  State<SpacexRockets> createState() => _SpacexRocketsState();
}

class _SpacexRocketsState extends State<SpacexRockets> {
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, streamSnapshot) {
              ...
              final docSnapshot = streamSnapshot.data!.docs.elementAt(2);
